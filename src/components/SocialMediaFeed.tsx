  ...
  const instagramPosts = [
    {
      ...
      likes: 1234,
      comments: 56,
      caption: "Seu pet merece o melhor! 🐶❤️ #MundoPetZen",
    },
    {
      id: "2",
      ...
      likes: 987,
      comments: 43,
      caption: "Novidades chegando! Fique ligado 🎉 #PetShop",
    },
    {
      id: "3",
      ...
      likes: 1567,
      comments: 78,
      caption: "Cliente feliz = Pet feliz! 😊🐱 #ClienteSatisfeito",
    },
    {
      id: "4",
      ...
      likes: 2134,
      comments: 92,
      caption: "Promoção especial! Não perca! 🔥 #Promo",
    },
    {
      id: "5",
      ...
      likes: 876,
      comments: 34,
      caption: "Cuidados essenciais para seu pet 💚 #DicasPet",
    },
    {
      id: "6",
      ...
      likes: 1432,
      comments: 67,
      caption: "Amor de quatro patas! 🐾❤️ #PetLove",
    },
  ];
    ...
    <div className="bg-white py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <a
            href="https://instagram.com/mundopetzen"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-md font-medium hover:from-purple-700 hover:to-pink-700"
          >
        ...
        <div className="mt-12 flex items-center justify-center gap-6">
          <a
            href="https://facebook.com/mundopetzen"
            target="_blank"
            rel="noopener noreferrer"
          ...
          <a
            href="https://twitter.com/mundopetzen"
            target="_blank"
            rel="noopener noreferrer"
          ...
          <a
            href="https://youtube.com/mundopetzen"
            target="_blank"
            rel="noopener noreferrer"
