...
export default function CheckoutPage() {
  ...
  const createSession = async () => {
    try {
      ...
      // Se o script já carregou, configurar
  ...
  const handlePayment = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // Obter sender hash (se script carregou)
      let senderHash = sessionId; // Fallback para session ID
      ...
      if (paymentMethod === "creditCard") {
        ...
        // Se script não carregou, processar sem token (modo fallback)
        if (!scriptLoaded || typeof PagSeguroDirectPayment === "undefined") {
        ...
        // Criar token do cartão (se script carregou)
